...
public final class GameRuleRegistry {
    ...
    public static final GameRules.Key<GameRules.IntegerValue> NOURISHMENT_REGEN_TICK_INTERVAL = register("nourishmentRegenTickInterval", GameRules.IntegerValue.create(5));
