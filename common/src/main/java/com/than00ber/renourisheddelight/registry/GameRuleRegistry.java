...
public final class GameRuleRegistry {
    ...
    public static final GameRules.Key<GameRules.IntegerValue> JUMP_FOOD_DRAIN = register("jumpFoodDrain", GameRules.IntegerValue.create(1));
    public static final GameRules.Key<GameRules.IntegerValue> SPRINT_FOOD_DRAIN = register("sprintFoodDrain", GameRules.IntegerValue.create(2));
